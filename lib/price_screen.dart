...
class _PriceScreenState extends State<PriceScreen> {
  ...
  void getData() async {
    List<double> data = await CoinData.getCoinData(selectedCurrency);
    try {
      int i = 0;
      for (double d in data) {
        print('1 ${cryptoList[i++]} = ${d.toString()} $selectedCurrency');
      }
      setState(() {
        // bitcoinValueInSelectedCurrency = data.toString;
      });
    } catch (e) {
      print(e);
    }
